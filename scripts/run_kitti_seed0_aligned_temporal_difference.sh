...
env -i \
    "${COMMON_ENV[@]}" \
    "PREDIFY_ALIGNED_DIFFERENCE_CHECKPOINT=${PREFIX}_best_student.pt" \
    "PREDIFY_ALIGNED_DIFFERENCE_EVAL_OUTPUT_DIR=$OUTPUT_ROOT/evaluation" \
    "$PYTHON_BIN" -u -m predify2021.mce_scores.evaluate_kitti_aligned_temporal_difference \
