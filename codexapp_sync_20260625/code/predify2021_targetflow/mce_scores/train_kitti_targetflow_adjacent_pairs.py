...
def run_epoch(student, teacher, dataloader, optimizer=None):
    ...
    iterator = tqdm(dataloader, desc="train" if training else "val")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        val_metrics = run_epoch(student, teacher, val_loader, optimizer=None) if val_loader is not None else None
