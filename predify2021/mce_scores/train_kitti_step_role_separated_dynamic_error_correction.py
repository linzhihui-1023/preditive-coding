...
def main():
    ...
    summary = {
        ...
        "config": {"epochs": EPOCHS, "optimizer": "AdamW", "learning_rate": LEARNING_RATE, "weight_decay": WEIGHT_DECAY, "seed": 0, "gaussian_noise_sigma": SIGMA, "alpha": 0.207, "beta": 0.793, "labels_used": False},
