...
def main():
    ...
    summary = {
        ...
        "config": {"seed": 0, "gaussian_noise_sigma": 0.10, "dynamic_error_sample_time": DYNAMIC_ERROR_SAMPLE_TIME, "dynamic_error_time_constant": DYNAMIC_ERROR_TIME_CONSTANT, "dynamic_error_gain": DYNAMIC_ERROR_GAIN, "corrected_layers": [1, 4], "labels_used_for_training": False},
