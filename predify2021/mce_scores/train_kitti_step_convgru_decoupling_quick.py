...
def main():
    ...
    if args.epochs == 0 and (out / "progress.json").exists():
        progress = json.loads((out / "progress.json").read_text())
        best = progress[-1]["best"]
